...
export const roadmap = [
  ...
  {
    id: "1",
    title: "MumbaiHacks 2024",
    text: "One of the World’s BIGGEST GenAI Hackathons!\nGet ready to create, compete, and win big at this year’s ultimate hackathon!",
    date: "Oct 25, 2024",
    status: "progress",
    imageUrl: roadmap2,
    domain: "Hackathon",
  ...
  },
  {
    ...
    text: "Hands-on sessions to learn modern web development frameworks and best practices.",
    date: "Feb 20, 2025",
    status: "upcoming",
    imageUrl: roadmap4,
    domain: "Education",
  },
  {
    ...
    text: "Join industry experts to discuss the ethical implications of AI technologies.",
    date: "Mar 10, 2025",
    status: "upcoming",
    imageUrl: roadmap4,
    domain: "Discussion",
  ...
  {
    id: "7",
    title: "Hackathon Preparation Sessions",
    text: "Workshops to prepare participants for upcoming hackathons, focusing on team dynamics and project planning.",
    date: "Apr 5, 2025",
    status: "upcoming",
    imageUrl: roadmap4,
    domain: "Workshop",
  },
  {
    ...
    text: "An introductory course on machine learning concepts and applications.",
    date: "May 15, 2025",
    status: "upcoming",
    imageUrl: roadmap4,
    domain: "Education",
  },
  {
    ...
    text: "Learn the fundamentals of cloud computing and its applications in modern technology.",
    date: "Jun 20, 2025",
    status: "upcoming",
    imageUrl: roadmap4,
    domain: "Education",
  },
  {
    ...
    text: "Explore the impact of AI technologies in the healthcare sector through expert talks and case studies.",
    date: "Jul 30, 2025",
    status: "upcoming",
    imageUrl: roadmap4,
    domain: "Symposium",
